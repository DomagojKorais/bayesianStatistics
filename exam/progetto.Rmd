...
kable(nesting%>%select(number,everything()),caption = "Data hierarchy")
```
...
kable(loo_compare(loo_A,loo_B,loo_B_priors),caption = "Loo comparisons") #model B wins
