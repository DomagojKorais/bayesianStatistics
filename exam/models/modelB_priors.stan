...
//reproduce model B of Langford, I.H., Bentham, G. and McDonald, A. (1998). Multilevel modelling of geographically aggregated health data: a case study on malignant melanoma mortality and UV exposure in the European community. Statistics in Medicine, 17, 41-58.
functions {
...
model {
  ...
  sigma_reg ~ gamma(10,30);
  sigma_nat ~ gamma(10,30);
  sigma_beta_reg ~  gamma(10,30);
  sigma_beta_nat ~  gamma(10,30);
